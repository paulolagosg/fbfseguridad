            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-white">
                      <form id="fcrear" action="{{ route('ordenes.agregar')}}" method="POST">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group mb-6">
                                ...
                                <select class="form-select form-select-lg mb-3
                                  ...
                                  ease-in-out
                                  m-0
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg" id="clie_ncod" name="clie_ncod" onchange="getDatosCliente(this.value)">
                                    <option>Seleccione</option>
                                    @foreach($clientes as $c)
                                        <option value='{{ $c->clie_ncod }}'
                                            @if( old('clie_ncod') == $c->clie_ncod)
                                                selected
                                            @endif
                            ...
                            <input type="text" class="form-control
                              ...
                              aria-describedby="" placeholder="" value="{{ old('clie_nrut') }}" readonly>
                          </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group mb-6">
                                ...
                                placeholder=""  value="{{ old('clie_tejecutivo') }}" readonly>
                            </div>
                            <div class="form-group mb-6">
                                ...
                                placeholder=""  value="{{ old('clie_tfonos') }}" readonly>
                            </div>
                        </div> 
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group  mb-6">
                                ...
                                placeholder=""  value="{{ old('clie_tcorreo') }}" readonly>
                            </div>
                            <div class="form-group form-check mb-6">
                                ...
                                placeholder=""  value="{{ old('clie_tdireccion') }}" readonly>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="flex items-center justify-center">
                                  <div class="datepicker relative form-floating mb-3 xl:w-96" data-mdb-toggle-button="false">
                                    <input type="text"
                                      ...
                                      placeholder="" data-mdb-toggle="datepicker" name="orde_finicio" id="orde_finicio" onblur="calculaDias($('#orde_finicio').val(),$('#orde_ftermino').val());" value="{{ old('orde_finicio') }}" />
                            ...
                            <div class="form-group mb-6">
                                ...
                                <div class="flex items-center justify-center">
                                  <div class="datepicker relative form-floating mb-3 xl:w-96" data-mdb-toggle-button="false">
                                    <input type="text"
                                      class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                      placeholder="" data-mdb-toggle="datepicker" name="orde_ftermino" id="orde_ftermino" onblur="calculaDias($('#orde_finicio').val(),$('#orde_ftermino').val());" value="{{ old('orde_ftermino') }}" />
                            ...
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="orde_ndias" id="orde_ndias"  value="{{ old('orde_ndias') }}"  onchange="calculaTotal($('#orde_nvalor_dia').val());">
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="orde_nvalor_dia" id="orde_nvalor_dia" onkeyup="calculaTotal(this.value);" value="{{ old('orde_nvalor_dia') }}">
                            </div>
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="orde_total_sin_iva" id="orde_total_sin_iva" readonly value="{{ old('orde_total_sin_iva') }}">
                            </div>
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="orde_total_con_iva" id="orde_total_con_iva" readonly value="{{ old('orde_total_con_iva') }}">
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"  name="orde_oc_cliente" id="orde_oc_cliente" value="{{ old('orde_oc_cliente') }}">
                            </div>
                            <div class="form-group mb-6">
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg"  name="pers_nrut_guardia" id="pers_nrut_guardia">
                                    ...
                                    @foreach($personas as $p)
                                        <option value='{{ $p->pers_nrut }}'
                                            @if(old('pers_nrut_guardia') == $p->pers_nrut)
                                                selected
                                            @endif
                                            >{{ $p->nombres}}</option> 
                                    @endforeach
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg"  name="jorn_ncod" id="jorn_ncod">
                                    ...
                                    @foreach($jornadas as $dato)
                                        <option value='{{ $dato->jorn_ncod }}'
                                            @if(old('jorn_ncod') == $dato->jorn_ncod)
                                                selected
                                            @endif
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="form-group mb-6">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="orde_tcomentario" id="orde_tcomentario">{{ old('orde_oc_cliente') }}</textarea> 
                            </div>
                        </div>
                        <p class="flex justify-end p-2">
                            ...
                            &nbsp;
                            <span style="display:none" id="spanProc">
                            	<i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i>
								<span class="sr-only">Loading...</span>
							</span>
                            <button type="button" onclick="$('#btnGuardar').hide();$('#spanProc').show();$('#fcrear').submit();" id="btnGuardar" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 ml-3">
