            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-white">
                      <form method="POST" action="{{ route('cursos.agregar')}}">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group mb-6">
                              ...
                              aria-describedby="curs_tnombre" placeholder="Nombre" value="{{ old('curs_tnombre')}}">
                            </div>
                            <div class="form-group mb-6">
                            <label for="exampleInputEmail1" class="form-label inline-block mb-2 text-gray-700">Estado</label>
                                <select class="form-select form-select-lg mb-3
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg example" id="curs_nestado" name="curs_nestado">
                                    ...
                                    <option value="0"
                                    @if(old('curs_nestado') == 0)
                                        selected 
                                    @endif
                                    >Inactivo</option>
									<option value="1"
                                    @if(old('curs_nestado') == 1)
                                        selected 
                                    @endif
                                    >Activo</option>
                                </select>
