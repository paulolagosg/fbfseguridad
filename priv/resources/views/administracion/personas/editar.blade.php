        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @foreach($datos_persona as $p)
                      <form method="POST" action="{{ route('personas.modificar')}}">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group mb-6">
                              ...
                              aria-describedby="pers_nrut" placeholder="RUT" value="{{ old('pers_nrut',$p->rut)}}" readonly>
                              <input type="hidden" name="pers_ncod" id="pers_ncod" value="{{ $p->pers_ncod}}">
                            </div>
                            <div class="form-group mb-6">
                            ...
                            <input type="text" class="form-control
                              ...
                              aria-describedby="pers_trazon_social" placeholder="Nombres" value="{{ old('pers_tnombres',$p->pers_tnombres)}}">
                          </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group mb-6">
                                ...
                                placeholder="Apellido Paterno" value="{{ old('pers_tpaterno',$p->pers_tpaterno)}}">
                            </div>
                            <div class="form-group mb-6">
                                ...
                                placeholder="Apellido Materno" value="{{ old('pers_tmaterno',$p->pers_tmaterno)}}">
                            </div>
                        </div> 
                        <div class="grid grid-cols-3 gap-4">
                            <div class="form-group mb-6">
                                ...
                                placeholder="Correo Electrónico" value="{{ old('pers_tcorreo',$p->pers_tcorreo)}}">
                            </div>
                            <div class="form-group mb-6">
                                ...
                                placeholder="Dirección" value="{{ old('pers_tdireccion',$p->pers_tdireccion)}}">
                            </div>
                                ...
                                <div class="flex items-center justify-center">
                                  <div class="datepicker relative form-floating mb-3 xl:w-96" data-mdb-toggle-button="false">
                                    <input type="text"
                                      ...
                                      placeholder="" data-mdb-toggle="datepicker" name="pers_fnacimiento" id="pers_fnacimiento" value="{{ old('pers_fnacimiento',$p->pers_fnacimiento) }}" />
                        ...
                        <div class="grid grid-cols-4 gap-4">
                        	<div class="form-group mb-6">
                                ...
                                placeholder="Teléfono fijo" value="{{ old('pers_nfono_fijo',$p->pers_nfono_fijo)}}">
                            </div>
                            <div class="form-group mb-6">
                                ...
                                placeholder="Teléfono móvil" value="{{ old('pers_nfono_movil',$p->pers_nfono_movil)}}">
                            </div>
                            <div class="form-group mb-6">
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg example" id="eciv_ncod" name="eciv_ncod">
                                    ...
                                    @foreach($estados_civiles as $ec)
                                        <option value="{{ $ec->eciv_ncod}}"
                                            @if( old('eciv_ncod') == $ec->eciv_ncod || $p->eciv_ncod == $ec->eciv_ncod)
                                                selected
                                            @endif
                                  ...
                                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-lg example" id="pers_nestado" name="pers_nestado">
                                    ...
                                    @foreach($estados as $e)
                                        <option value="{{ $e->esta_ncod}}"
                                            @if( old('pers_nestado') == $e->esta_ncod || $p->pers_nestado == $e->esta_ncod)
                                                selected
                                            @endif
